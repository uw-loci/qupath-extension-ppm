...
public class PPMBoundingBoxUI implements ModalityHandler.BoundingBoxUI {
    ...
    public PPMBoundingBoxUI() {
        ...
        overrideAngles.setTooltip(new Tooltip("Override the default +/- rotation angles from config_ppm.yml\n"
        ...
        plusSpinner.setTooltip(new Tooltip("Positive rotation angle in hardware ticks.\n"
        ...
        minusSpinner.setTooltip(new Tooltip("Negative rotation angle in hardware ticks.\n"
