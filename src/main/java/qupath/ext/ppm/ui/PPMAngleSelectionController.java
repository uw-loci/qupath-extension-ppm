...
public class PPMAngleSelectionController {
     ...
     *               subfolder, not a stale legacy flat-path file.
    ...
    public static CompletableFuture<AngleExposureResult> showDialog(
        ...
        Platform.runLater(() -> {
            ...
            minusCheck.setTooltip(new Tooltip("Negative rotation angle. Paired with the positive angle\n"
            ...
            zeroCheck.setTooltip(new Tooltip("Crossed polarizers (0 deg). Baseline extinction position\n"
            ...
            plusCheck.setTooltip(new Tooltip("Positive rotation angle. Paired with the negative angle\n"
                    + "to compute birefringence (difference image)."));
            ...
            uncrossedCheck.setTooltip(new Tooltip("Uncrossed (parallel) polarizers. Provides a bright-field\n"
    ...
    private static void updateDynamicWarnings(
        ...
        try {
            ...
            // Mode-specific background lookup -- read the subfolder matching
            // the user's selected WB mode, not a stale top-level legacy file
            // (root cause of 2026-04-15 false mismatch warning incident).
    ...
    private static void validateAgainstBackgroundSettingsAsync(
        ...
        try {
            ...
            if (backgroundSettings == null) {
                logger.debug(
                        "No background settings found for {}/{}/{} (wbMode={}) - skipping validation",
                        modality,
                        objective,
                        detector,
                        wbMode);
